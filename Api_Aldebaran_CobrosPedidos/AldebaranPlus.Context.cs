...
namespace Api_Aldebaran_CobrosPedidos
{
    ...
    public partial class ChinoServer : DbContext
    {
        public ChinoServer()
            : base("name=ChinoServer")
        {
        }
        ...
        public virtual DbSet<CamposTransaccion> CamposTransaccion { get; set; }
        public virtual DbSet<ParamTipoDocumento> ParamTipoDocumento { get; set; }
        public virtual DbSet<PlanContable> PlanContable { get; set; }
        public virtual DbSet<ProductoContabilidad> ProductoContabilidad { get; set; }
        public virtual DbSet<ProveedorContabilidad> ProveedorContabilidad { get; set; }
        ...
        public virtual DbSet<FacturaContabilidad> FacturaContabilidad { get; set; }
        ...
        public virtual DbSet<vVentaFContabilidad> vVentaFContabilidad { get; set; }
        ...
        public virtual IQueryable<split_Result> split(string delimited, string delimiter)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<split_Result>("[ChinoServer].[split](@delimited, @delimiter)", delimitedParameter, delimiterParameter);
        }
    
        [DbFunction("ChinoServer", "secuencia2")]
        public virtual IQueryable<secuencia2_Result> secuencia2()
        {
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<secuencia2_Result>("[ChinoServer].[secuencia2]()");
        }
    
        public virtual ObjectResult<string> Del_Asiento(Nullable<int> iD, string usuario, string estacion)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("Del_Asiento", iDParameter, usuarioParameter, estacionParameter);
        }
    
        public virtual ObjectResult<string> Del_CamposTransaccion(Nullable<int> iD, string usuario, string estacion)
        {
            var iDParameter = iD.HasValue ?
                new ObjectParameter("ID", iD) :
                new ObjectParameter("ID", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("Del_CamposTransaccion", iDParameter, usuarioParameter, estacionParameter);
        }
    
        public virtual ObjectResult<string> Del_ParametrosDocumento(Nullable<int> iD, string usuario, string estacion)
        {
            var iDParameter = iD.HasValue ?
                new ObjectParameter("ID", iD) :
                new ObjectParameter("ID", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("Del_ParametrosDocumento", iDParameter, usuarioParameter, estacionParameter);
        }
    
        public virtual ObjectResult<string> Del_TipoDocumento(Nullable<int> iD, string usuario, string estacion)
        {
            var iDParameter = iD.HasValue ?
                new ObjectParameter("ID", iD) :
                new ObjectParameter("ID", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("Del_TipoDocumento", iDParameter, usuarioParameter, estacionParameter);
        }
    
        public virtual ObjectResult<string> Del_TipoTransaccion(Nullable<int> iD, string usuario, string estacion)
        {
            var iDParameter = iD.HasValue ?
                new ObjectParameter("ID", iD) :
                new ObjectParameter("ID", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("Del_TipoTransaccion", iDParameter, usuarioParameter, estacionParameter);
        }
    
        public virtual ObjectResult<string> Ins_Asiento(string jsonData)
        {
            var jsonDataParameter = jsonData != null ?
                new ObjectParameter("JsonData", jsonData) :
                new ObjectParameter("JsonData", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("Ins_Asiento", jsonDataParameter);
        }
    
        public virtual ObjectResult<string> Ins_CamposTransaccion(string jsonData)
        {
            var jsonDataParameter = jsonData != null ?
                new ObjectParameter("JsonData", jsonData) :
                new ObjectParameter("JsonData", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("Ins_CamposTransaccion", jsonDataParameter);
        }
    
        public virtual ObjectResult<string> Ins_ParametrosDocumento(string jsonData)
        {
            var jsonDataParameter = jsonData != null ?
                new ObjectParameter("JsonData", jsonData) :
                new ObjectParameter("JsonData", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("Ins_ParametrosDocumento", jsonDataParameter);
        }
    
        public virtual ObjectResult<string> Ins_PlanContable(string jsonData)
        {
            var jsonDataParameter = jsonData != null ?
                new ObjectParameter("JsonData", jsonData) :
                new ObjectParameter("JsonData", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("Ins_PlanContable", jsonDataParameter);
        }
    
        public virtual ObjectResult<string> Ins_PlanCuenta(string jsonData, Nullable<int> iDP)
        {
            var jsonDataParameter = jsonData != null ?
                new ObjectParameter("JsonData", jsonData) :
                new ObjectParameter("JsonData", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("Ins_PlanCuenta", jsonDataParameter, iDPParameter);
        }
    
        public virtual ObjectResult<string> Ins_ProductoContabilidad(string jsonData)
        {
            var jsonDataParameter = jsonData != null ?
                new ObjectParameter("JsonData", jsonData) :
                new ObjectParameter("JsonData", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("Ins_ProductoContabilidad", jsonDataParameter);
        }
    
        public virtual ObjectResult<string> Ins_ProveedorContabilidad(string jsonData)
        {
            var jsonDataParameter = jsonData != null ?
                new ObjectParameter("JsonData", jsonData) :
                new ObjectParameter("JsonData", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("Ins_ProveedorContabilidad", jsonDataParameter);
        }
    
        public virtual ObjectResult<string> Ins_TipoDocumento(string jsonData)
        {
            var jsonDataParameter = jsonData != null ?
                new ObjectParameter("JsonData", jsonData) :
                new ObjectParameter("JsonData", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("Ins_TipoDocumento", jsonDataParameter);
        }
    
        public virtual ObjectResult<string> Ins_TipoTransaccion(string jsonData)
        {
            var jsonDataParameter = jsonData != null ?
                new ObjectParameter("JsonData", jsonData) :
                new ObjectParameter("JsonData", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("Ins_TipoTransaccion", jsonDataParameter);
        }
    
        public virtual ObjectResult<string> Sel_Asiento(string accion, Nullable<bool> tipoJson, string usuario, string estacion, Nullable<int> iD, Nullable<int> iDSU, string texto, string estado)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("Sel_Asiento", accionParameter, tipoJsonParameter, usuarioParameter, estacionParameter, iDParameter, iDSUParameter, textoParameter, estadoParameter);
        }
    
        public virtual ObjectResult<string> Sel_CamposTransaccion(string accion, Nullable<bool> tipoJson, string usuario, string estacion, Nullable<int> iD, Nullable<int> iDSU, string texto, string estado)
        {
            var accionParameter = accion != null ?
                new ObjectParameter("Accion", accion) :
                new ObjectParameter("Accion", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("Sel_CamposTransaccion", accionParameter, tipoJsonParameter, usuarioParameter, estacionParameter, iDParameter, iDSUParameter, textoParameter, estadoParameter);
        }
    
        public virtual ObjectResult<string> Sel_FacturasContable(string accion, Nullable<bool> tipoJson, string usuario, string estacion, Nullable<int> limite)
        {
            var accionParameter = accion != null ?
                new ObjectParameter("Accion", accion) :
                new ObjectParameter("Accion", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("Sel_FacturasContable", accionParameter, tipoJsonParameter, usuarioParameter, estacionParameter, limiteParameter);
        }
    
        public virtual ObjectResult<string> Sel_ParametrosDocumento(string accion, Nullable<bool> tipoJson, string usuario, string estacion, Nullable<int> iD, Nullable<int> iDTD, string texto, string estado)
        {
            var accionParameter = accion != null ?
                new ObjectParameter("Accion", accion) :
                new ObjectParameter("Accion", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("Sel_ParametrosDocumento", accionParameter, tipoJsonParameter, usuarioParameter, estacionParameter, iDParameter, iDTDParameter, textoParameter, estadoParameter);
        }
    
        public virtual ObjectResult<string> Sel_PlanContable(string accion, Nullable<bool> tipoJson, Nullable<int> iD, Nullable<int> iDEM, string texto, string estado)
        {
            var accionParameter = accion != null ?
                new ObjectParameter("Accion", accion) :
                new ObjectParameter("Accion", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("Sel_PlanContable", accionParameter, tipoJsonParameter, iDParameter, iDEMParameter, textoParameter, estadoParameter);
        }
    
        public virtual ObjectResult<Sel_PlanCuenta_Result> Sel_PlanCuenta(string accion, Nullable<bool> tipoJson, string usuario, string estacion, Nullable<int> iD, Nullable<int> iDEM, string texto, string estado)
        {
            var accionParameter = accion != null ?
                new ObjectParameter("Accion", accion) :
                new ObjectParameter("Accion", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Sel_PlanCuenta_Result>("Sel_PlanCuenta", accionParameter, tipoJsonParameter, usuarioParameter, estacionParameter, iDParameter, iDEMParameter, textoParameter, estadoParameter);
        }
    
        public virtual ObjectResult<string> Sel_ProductoContabilidad(string accion, Nullable<bool> tipoJson, Nullable<int> iD, string usuario, string estacion, string estado)
        {
            var accionParameter = accion != null ?
                new ObjectParameter("Accion", accion) :
                new ObjectParameter("Accion", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("Sel_ProductoContabilidad", accionParameter, tipoJsonParameter, iDParameter, usuarioParameter, estacionParameter, estadoParameter);
        }
    
        public virtual ObjectResult<string> Sel_ProveedorContabilidad(string accion, Nullable<bool> tipoJson, Nullable<int> iD, string usuario, string estacion, string estado)
        {
            var accionParameter = accion != null ?
                new ObjectParameter("Accion", accion) :
                new ObjectParameter("Accion", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("Sel_ProveedorContabilidad", accionParameter, tipoJsonParameter, iDParameter, usuarioParameter, estacionParameter, estadoParameter);
        }
    
        public virtual ObjectResult<string> Sel_TipoDocumento(string accion, Nullable<bool> tipoJson, string usuario, string estacion, Nullable<int> iD, Nullable<int> iDSU, string texto, string estado)
        {
            var accionParameter = accion != null ?
                new ObjectParameter("Accion", accion) :
                new ObjectParameter("Accion", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("Sel_TipoDocumento", accionParameter, tipoJsonParameter, usuarioParameter, estacionParameter, iDParameter, iDSUParameter, textoParameter, estadoParameter);
        }
    
        public virtual ObjectResult<string> Sel_TipoTransaccion(string accion, Nullable<bool> tipoJson, string usuario, string estacion, Nullable<int> iD, Nullable<int> iDSU, string texto, string estado)
        {
            var accionParameter = accion != null ?
                new ObjectParameter("Accion", accion) :
                new ObjectParameter("Accion", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("Sel_TipoTransaccion", accionParameter, tipoJsonParameter, usuarioParameter, estacionParameter, iDParameter, iDSUParameter, textoParameter, estadoParameter);
        }
    
        public virtual int Upd_Asiento(string accion, Nullable<int> iD, string jsonData)
        {
            var accionParameter = accion != null ?
                new ObjectParameter("Accion", accion) :
                new ObjectParameter("Accion", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("Upd_Asiento", accionParameter, iDParameter, jsonDataParameter);
        }
    
        public virtual ObjectResult<string> Upd_CamposTransaccion(string accion, Nullable<int> iD, string jsonData)
        {
            var accionParameter = accion != null ?
                new ObjectParameter("Accion", accion) :
                new ObjectParameter("Accion", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("Upd_CamposTransaccion", accionParameter, iDParameter, jsonDataParameter);
        }
    
        public virtual ObjectResult<string> Upd_ParametrosDocumento(string accion, Nullable<int> iD, string jsonData)
        {
            var accionParameter = accion != null ?
                new ObjectParameter("Accion", accion) :
                new ObjectParameter("Accion", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("Upd_ParametrosDocumento", accionParameter, iDParameter, jsonDataParameter);
        }
    
        public virtual ObjectResult<string> Upd_ProductoContabilidad(string accion, Nullable<int> iD, string jsonData)
        {
            var accionParameter = accion != null ?
                new ObjectParameter("Accion", accion) :
                new ObjectParameter("Accion", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("Upd_ProductoContabilidad", accionParameter, iDParameter, jsonDataParameter);
        }
    
        public virtual ObjectResult<string> Upd_ProveedorContabilidad(string accion, Nullable<int> iD, string jsonData)
        {
            var accionParameter = accion != null ?
                new ObjectParameter("Accion", accion) :
                new ObjectParameter("Accion", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("Upd_ProveedorContabilidad", accionParameter, iDParameter, jsonDataParameter);
        }
    
        public virtual ObjectResult<string> Upd_TipoDocumento(string accion, Nullable<int> iD, string jsonData)
        {
            var accionParameter = accion != null ?
                new ObjectParameter("Accion", accion) :
                new ObjectParameter("Accion", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("Upd_TipoDocumento", accionParameter, iDParameter, jsonDataParameter);
        }
    
        public virtual ObjectResult<string> Upd_TipoTransaccion(string accion, Nullable<int> iD, string jsonData)
        {
            var accionParameter = accion != null ?
                new ObjectParameter("Accion", accion) :
                new ObjectParameter("Accion", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("Upd_TipoTransaccion", accionParameter, iDParameter, jsonDataParameter);
        }
        ...
        public virtual int Ins_FactTHabiente(Nullable<int> iDCT, Nullable<int> iDSU, Nullable<int> iDPT, Nullable<int> iDUS, Nullable<int> iDEP, Nullable<System.DateTime> fecha, string tipo, string formaPago, Nullable<decimal> porcentajeComision, Nullable<decimal> comision, Nullable<decimal> subtotalIVA, Nullable<decimal> subtotalIVA0, Nullable<decimal> subtotal, Nullable<decimal> porcentajeDesc, Nullable<decimal> descuento, Nullable<decimal> subtotalIVADesc, Nullable<decimal> subtotalIVA0Desc, Nullable<decimal> iVA, Nullable<decimal> total, Nullable<decimal> saldo, string estado, Nullable<decimal> efectivo, Nullable<decimal> cambio, Nullable<bool> impreso, ObjectParameter numeroOut)
        {
            var iDCTParameter = iDCT.HasValue ?
                new ObjectParameter("IDCT", iDCT) :
                new ObjectParameter("IDCT", typeof(int));
        ...
        public virtual ObjectResult<Rpt_CierreCajaGeneral_Result> Rpt_CierreCajaGeneral(string jSONData)
        {
            var jSONDataParameter = jSONData != null ?
                new ObjectParameter("JSONData", jSONData) :
                new ObjectParameter("JSONData", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Rpt_CierreCajaGeneral_Result>("Rpt_CierreCajaGeneral", jSONDataParameter);
        }
        ...
        public virtual ObjectResult<Rpt_SubCierreCajaGeneralCuadre_Result> Rpt_SubCierreCajaGeneralCuadre(string jSONData)
        {
            var jSONDataParameter = jSONData != null ?
                new ObjectParameter("JSONData", jSONData) :
                new ObjectParameter("JSONData", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Rpt_SubCierreCajaGeneralCuadre_Result>("Rpt_SubCierreCajaGeneralCuadre", jSONDataParameter);
        }
    
        public virtual ObjectResult<Rpt_SubCierreCajaGeneralEgresos_Result> Rpt_SubCierreCajaGeneralEgresos(string jSONData)
        {
            var jSONDataParameter = jSONData != null ?
                new ObjectParameter("JSONData", jSONData) :
                new ObjectParameter("JSONData", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Rpt_SubCierreCajaGeneralEgresos_Result>("Rpt_SubCierreCajaGeneralEgresos", jSONDataParameter);
        }
    
        public virtual ObjectResult<Rpt_SubCierreCajaGeneralIngresos_Result> Rpt_SubCierreCajaGeneralIngresos(string jSONData)
        {
            var jSONDataParameter = jSONData != null ?
                new ObjectParameter("JSONData", jSONData) :
                new ObjectParameter("JSONData", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Rpt_SubCierreCajaGeneralIngresos_Result>("Rpt_SubCierreCajaGeneralIngresos", jSONDataParameter);
        }
        ...
        public virtual ObjectResult<Rpt_VentasComparativaxAnio_Result> Rpt_VentasComparativaxAnio(Nullable<int> iDUS, Nullable<int> anio1, Nullable<int> anio2)
        {
            var iDUSParameter = iDUS.HasValue ?
                new ObjectParameter("IDUS", iDUS) :
                new ObjectParameter("IDUS", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Rpt_VentasComparativaxAnio_Result>("Rpt_VentasComparativaxAnio", iDUSParameter, anio1Parameter, anio2Parameter);
        }
        ...
        public virtual ObjectResult<Sel_AperturaCaja_Result> Sel_AperturaCaja(string accion, Nullable<int> iD, Nullable<int> iDPtoVenta, Nullable<int> iDUsuario, Nullable<int> iDSU, Nullable<System.DateTime> fechApertura, Nullable<System.DateTime> fechCierre)
        {
            var accionParameter = accion != null ?
                new ObjectParameter("Accion", accion) :
                new ObjectParameter("Accion", typeof(string));
            ...
            var fechAperturaParameter = fechApertura.HasValue ?
                new ObjectParameter("FechApertura", fechApertura) :
                new ObjectParameter("FechApertura", typeof(System.DateTime));
    
            var fechCierreParameter = fechCierre.HasValue ?
                new ObjectParameter("FechCierre", fechCierre) :
                new ObjectParameter("FechCierre", typeof(System.DateTime));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Sel_AperturaCaja_Result>("Sel_AperturaCaja", accionParameter, iDParameter, iDPtoVentaParameter, iDUsuarioParameter, iDSUParameter, fechAperturaParameter, fechCierreParameter);
        }
        ...
        public virtual ObjectResult<string> Upd_EstadoTarjetaHabiente(string accion, Nullable<int> iD, string jsonData)
        {
            var accionParameter = accion != null ?
                new ObjectParameter("Accion", accion) :
                new ObjectParameter("Accion", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("Upd_EstadoTarjetaHabiente", accionParameter, iDParameter, jsonDataParameter);
        }
        ...
        public virtual int Ins_FElectronica(string jsonData, string servidor, string baseDatos, Nullable<int> iDAmbiente, Nullable<int> iDTipoDocumento, string usuario, string estacion, ObjectParameter fProblemas)
        {
            var jsonDataParameter = jsonData != null ?
                new ObjectParameter("JsonData", jsonData) :
                new ObjectParameter("JsonData", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("Ins_FElectronica", jsonDataParameter, servidorParameter, baseDatosParameter, iDAmbienteParameter, iDTipoDocumentoParameter, usuarioParameter, estacionParameter, fProblemas);
        }
        ...
        public virtual int Ins_RElectronica(string jsonData, string servidor, string baseDatos, Nullable<int> iDAmbiente, Nullable<int> iDTipoDocumento, string usuario, string estacion, ObjectParameter fProblemas)
        {
            var jsonDataParameter = jsonData != null ?
                new ObjectParameter("JsonData", jsonData) :
                new ObjectParameter("JsonData", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("Ins_RElectronica", jsonDataParameter, servidorParameter, baseDatosParameter, iDAmbienteParameter, iDTipoDocumentoParameter, usuarioParameter, estacionParameter, fProblemas);
        }
        ...
        public virtual int Rpt_SelTarjetaHabienteDetalles(string estadoTH, Nullable<int> iDCT, Nullable<int> iDSU, Nullable<System.DateTime> fechDesde, Nullable<System.DateTime> fechHasta)
        {
            var estadoTHParameter = estadoTH != null ?
                new ObjectParameter("EstadoTH", estadoTH) :
                new ObjectParameter("EstadoTH", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("Rpt_SelTarjetaHabienteDetalles", estadoTHParameter, iDCTParameter, iDSUParameter, fechDesdeParameter, fechHastaParameter);
        }
    
        public virtual int Rpt_SelTotalesTarjetaHabiente(string estadoTH, Nullable<int> iDCT, Nullable<int> iDSU, Nullable<System.DateTime> fechDesde, Nullable<System.DateTime> fechHasta)
        {
            var estadoTHParameter = estadoTH != null ?
                new ObjectParameter("EstadoTH", estadoTH) :
                new ObjectParameter("EstadoTH", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("Rpt_SelTotalesTarjetaHabiente", estadoTHParameter, iDCTParameter, iDSUParameter, fechDesdeParameter, fechHastaParameter);
        }
