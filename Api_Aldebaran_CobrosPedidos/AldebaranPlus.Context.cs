...
namespace Api_Aldebaran_CobrosPedidos
{
    ...
    public partial class AldebaranPlus : DbContext
    {
        public AldebaranPlus()
            : base("name=AldebaranPlus")
        {
        }
        ...
        [DbFunction("AldebaranPlus", "split")]
        public virtual IQueryable<split_Result> split(string delimited, string delimiter)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<split_Result>("[AldebaranPlus].[split](@delimited, @delimiter)", delimitedParameter, delimiterParameter);
        }
    
        [DbFunction("AldebaranPlus", "secuencia2")]
        public virtual IQueryable<secuencia2_Result> secuencia2()
        {
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<secuencia2_Result>("[AldebaranPlus].[secuencia2]()");
        }
